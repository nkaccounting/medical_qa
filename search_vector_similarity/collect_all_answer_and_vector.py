...
name = "all"
out_name = "search_answer_vector"
out_name1 = "../data/search_answer.csv"
...
answers = pd.Series(list(set(dataframe["answer"])))
...
for answer in answers:
    vector = get_sentence_embedding(answer)
...
df["answers"].to_csv(out_name1, encoding="utf-8", index=0)
